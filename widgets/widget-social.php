...
class ProGo_Widget_Social extends WP_Widget {
	...
	function widget( $args, $instance ) {
		extract($args);
		$title = apply_filters( 'widget_title', empty($instance['title']) ? __('Connect With Us') : $instance['title'], $instance, $this->id_base);
	...
	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array( 'title' => 'Connect With Us', 'facebook' => '', 'twitter' => '', 'gplus' => '', 'pinterest' => '', 'youtube' => '', 'vimeo' => '', 'linkedin' => '', 'rss' => 'yes') );
